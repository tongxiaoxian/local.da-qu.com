				...
				<div id="channel_prefs-<?= $channel->channel_name ?>">
					...
					<table>
						<tbody>
                            ...
                            <tr class="even">
								<th scope="row"><?= lang("fallback_description"); ?></th>
								<td><?php 
										echo $EE->nsm_better_meta_helper->selectbox(
											$input_prefix."[channels][" . $channel->channel_id . "][fallback_description]",
											(isset($fields_by_channel[$channel->channel_id]) ? array_merge(array('None' => null), $fields_by_channel[$channel->channel_id]) : array('None' => null)),
											$channel_settings['fallback_description'],
											array()
										);
									?>
								</td>
