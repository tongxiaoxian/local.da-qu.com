 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://local.photobook.cafe/admin.php'; 
   $assign_to_config['site_url'] = 'http://local.photobook.cafe/';
...
$assign_to_config['tmpl_file_basepath'] = '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/photobook.cafe/templates';

$assign_to_config['upload_preferences'] = array(
    60 => array(                                                            // ID of upload destination
        'name'        => 'journal',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/photobook.cafe/assets/images/uploads/journal/', // Server path to upload directory
        'url'         => 'http://local.photobook.cafe/assets/images/uploads/journal/'      // URL of upload directory
    ),
    61 => array(                                                            // ID of upload destination
        'name'        => 'food',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/photobook.cafe/assets/images/uploads/food/', // Server path to upload directory
        'url'         => 'http://local.photobook.cafe/assets/images/uploads/food/'      // URL of upload directory
    ),
    62 => array(                                                            // ID of upload destination
        'name'        => 'shelf',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/photobook.cafe/assets/images/uploads/shelf/', // Server path to upload directory
        'url'         => 'http://local.photobook.cafe/assets/images/uploads/shelf/'      // URL of upload directory
    ),
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/photobook.cafe/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.photobook.cafe/cache',
