...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/da-qu.com/msm/photobook.cafe/templates';

$assign_to_config['upload_preferences'] = array(
    60 => array(                                                            // ID of upload destination
        'name'        => 'journal',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/photobook.cafe/assets/images/uploads/journal/', // Server path to upload directory
        'url'         => 'http://www.photobook.cafe/assets/images/uploads/journal/'      // URL of upload directory
    ),
    60 => array(                                                            // ID of upload destination
        'name'        => 'food',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/photobook.cafe/assets/images/uploads/food/', // Server path to upload directory
        'url'         => 'http://www.photobook.cafe/assets/images/uploads/food/'      // URL of upload directory
    ),
    60 => array(                                                            // ID of upload destination
        'name'        => 'shelf',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/photobook.cafe/assets/images/uploads/shelf/', // Server path to upload directory
        'url'         => 'http://www.photobook.cafe/assets/images/uploads/shelf/'      // URL of upload directory
    ),
    60 => array(                                                            // ID of upload destination
        'name'        => 'about',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/photobook.cafe/assets/images/uploads/about/', // Server path to upload directory
        'url'         => 'http://www.photobook.cafe/assets/images/uploads/about/'      // URL of upload directory
    )    
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/da-qu.com/msm/photobook.cafe/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://www.photobook.cafe/cache',
