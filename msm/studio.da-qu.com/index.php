 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://local.studio.da-qu.com/admin.php';
   $assign_to_config['site_url'] = 'http://local.studio.da-qu.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/studio.da-qu.com/templates';
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/msm/studio.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.studio.da-qu.com/cache',
