...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/tongxiaoxian.com/msm/nan-su.com/templates';

$assign_to_config['upload_preferences'] = array(
    38 => array(                                                            // ID of upload destination
        'name'        => 'products_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/tongxiaoxian.com/msm/nan-su.com/assets/images/uploads/products_cn/', // Server path to upload directory
        'url'         => 'http://www.nan-su.com/assets/images/uploads/products_cn/'      // URL of upload directory
    )                  
);
