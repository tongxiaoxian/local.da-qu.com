 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://www.nightblindnesscafe.com/admin.php';
   $assign_to_config['site_url'] = 'http://www.nightblindnesscafe.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/da-qu.com/msm/nightblindnesscafe.com/templates';
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/da-qu.com/msm/nightblindnesscafe.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://www.nightblindnesscafe.com/cache',
