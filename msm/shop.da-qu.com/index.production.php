 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://shop.da-qu.com/admin.php';
   $assign_to_config['site_url'] = 'http://shop.da-qu.com/';
...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/da-qu.com/msm/shop.da-qu.com/templates';
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/tongxiaoxian.com/msm/shop.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://shop.da-qu.com/cache',
