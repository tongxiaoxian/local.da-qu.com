...
$assign_to_config['upload_preferences'] = array(
    51 => array(                                                            // ID of upload destination
        'name'        => 'blog',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/public_html/assets/images/uploads/blog/', // Server path to upload directory
        'url'         => 'http://local.tongxiaoxian.com/assets/images/uploads/blog/'      // URL of upload directory
    ),
    52 => array(                                                            // ID of upload destination
        'name'        => 'portrait',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/public_html/assets/images/uploads/portrait/', // Server path to upload directory
        'url'         => 'http://local.tongxiaoxian.com/assets/images/uploads/portrait/'      // URL of upload directory
    ),
    53 => array(                                                            // ID of upload destination
        'name'        => 'travel',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/public_html/assets/images/uploads/travel/', // Server path to upload directory
        'url'         => 'http://local.tongxiaoxian.com/assets/images/uploads/travel/'      // URL of upload directory
    )
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/msm/tongxiaoxian.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.tongxiaoxian.com/cache',
