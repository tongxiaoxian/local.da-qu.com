 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://www.ncafe.co/admin.php';
   $assign_to_config['site_url'] = 'http://www.ncafe.co/';
...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/da-qu.com/msm/ncafe.co/templates';
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/tongxiaoxian.com/msm/www.ncafe.co/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://www.ncafe.co/cache',
