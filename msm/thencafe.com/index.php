 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://local.thencafe.com/admin.php';
   $assign_to_config['site_url'] = 'http://local.thencafe.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/thencafe.com/templates';
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/msm/thencafe.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.thencafe.com/cache',
