...
$assign_to_config['upload_preferences'] = array(           
    40 => array(                                                            // ID of upload destination
        ...
        'server_path' => '/var/www/html/da-qu.com/msm/travels.da-qu.com/assets/images/uploads/blog_cn/', // Server path to upload directory
        'url'         => 'http://travels.da-qu.com/assets/images/uploads/blog_cn/'      // URL of upload directory
    ),
    41 => array(                                                            // ID of upload destination
        'name'        => 'weddings_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/travels.da-qu.com/assets/images/uploads/weddings_cn/', // Server path to upload directory
        'url'         => 'http://travels.da-qu.com/assets/images/uploads/weddings_cn/'      // URL of upload directory
    ),
    42 => array(                                                            // ID of upload destination
        'name'        => 'portraits_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/travels.da-qu.com/assets/images/uploads/portraits_cn/', // Server path to upload directory
        'url'         => 'http://travels.da-qu.com/assets/images/uploads/portraits_cn/'      // URL of upload directory
    ),
    48 => array(                                                            // ID of upload destination
        'name'        => 'locations_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/travels.da-qu.com/assets/images/uploads/locations_cn/', // Server path to upload directory
        'url'         => 'http://travels.da-qu.com/assets/images/uploads/locations_cn/'      // URL of upload directory
    ),
    49 => array(                                                            // ID of upload destination
        'name'        => 'accomodations_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/travels.da-qu.com/assets/images/uploads/accomodations_cn/', // Server path to upload directory
        'url'         => 'http://travels.da-qu.com/assets/images/uploads/accomodations_cn/'      // URL of upload directory
    ),
    50 => array(                                                            // ID of upload destination
        'name'        => 'hospitalities_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/travels.da-qu.com/assets/images/uploads/hospitalities_cn/', // Server path to upload directory
        'url'         => 'http://travels.da-qu.com/assets/images/uploads/hospitalities_cn/'      // URL of upload directory
    ) 
);
