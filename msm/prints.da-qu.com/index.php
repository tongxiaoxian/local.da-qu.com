 ...
 *
 */
   $assign_to_config['site_name']  = 'prints'; 
   $assign_to_config['cp_url'] = 'http://local.prints.da-qu.com/admin.php'; 
   $assign_to_config['site_url'] = 'http://local.prints.da-qu.com/'; 
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.tongxiaoxian.com/msm/prints.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.prints.da-qu.com/cache',
