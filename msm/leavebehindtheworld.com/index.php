 ...
 *
 */
   $assign_to_config['site_name']  = 'weddings'; 
   $assign_to_config['cp_url'] = 'http://local.weddings.da-qu.com/admin.php'; 
   $assign_to_config['site_url'] = 'http://local.weddings.da-qu.com/';
...
$assign_to_config['tmpl_file_basepath'] = '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/templates';

$assign_to_config['upload_preferences'] = array(
    40 => array(                                                            // ID of upload destination
        'name'        => 'blog',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/assets/images/uploads/blog/', // Server path to upload directory
        'url'         => 'http://local.weddings.da-qu.com/assets/images/uploads/blog/'      // URL of upload directory
    ),
    41 => array(                                                            // ID of upload destination
        'name'        => 'weddings',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/assets/images/uploads/weddings/', // Server path to upload directory
        'url'         => 'http://local.weddings.da-qu.com/assets/images/uploads/weddings/'      // URL of upload directory
    ),
    42 => array(                                                            // ID of upload destination
        'name'        => 'portraits',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/assets/images/uploads/portraits/', // Server path to upload directory
        'url'         => 'http://local.weddings.da-qu.com/assets/images/uploads/portraits/'      // URL of upload directory
    ),
    48 => array(                                                            // ID of upload destination
        'name'        => 'locations',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/assets/images/uploads/locations/', // Server path to upload directory
        'url'         => 'http://local.weddings.da-qu.com/assets/images/uploads/locations/'      // URL of upload directory
    ),
    49 => array(                                                            // ID of upload destination
        'name'        => 'accomodations',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/assets/images/uploads/accomodations/', // Server path to upload directory
        'url'         => 'http://local.weddings.da-qu.com/assets/images/uploads/accomodations/'      // URL of upload directory
    ),
    50 => array(                                                            // ID of upload destination
        'name'        => 'hospitalities',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/assets/images/uploads/hospitalities/', // Server path to upload directory
        'url'         => 'http://local.weddings.da-qu.com/assets/images/uploads/hospitalities/'      // URL of upload directory
    )             
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/weddings.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.weddings.da-qu.com/cache',
