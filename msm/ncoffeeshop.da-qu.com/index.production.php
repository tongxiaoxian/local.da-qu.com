 ...
 */
   ...
   $assign_to_config['site_url'] = 'http://ncoffeeshop.da-qu.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/tongxiaoxian.com/msm/ncoffeeshop.da-qu.com/templates';

$assign_to_config['upload_preferences'] = array(
    38 => array(                                                            // ID of upload destination
        'name'        => 'products_cn',                          // Display name in control panel
        'server_path' => '/var/www/html/tongxiaoxian.com/msm/ncoffee.com/assets/images/uploads/products_cn/', // Server path to upload directory
        'url'         => 'http://www.ncoffee.com/assets/images/uploads/products_cn/'      // URL of upload directory
    )                  
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/tongxiaoxian.com/msm/ncoffee.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://www.ncoffee.com/cache',
