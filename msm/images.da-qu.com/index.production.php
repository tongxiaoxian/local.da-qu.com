 ...
 *
 */
   $assign_to_config['site_name']  = 'images'; 
   $assign_to_config['cp_url'] = 'http://images.da-qu.com/admin.php'; 
   $assign_to_config['site_url'] = 'http://images.da-qu.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/var/www/html/da-qu.com/msm/images.da-qu.com/templates';

$assign_to_config['upload_preferences'] = array(
    44 => array(                                                            // ID of upload destination
        'name'        => 'portrait',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/portrait/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/portrait/'      // URL of upload directory
    ),
    46 => array(                                                            // ID of upload destination
        'name'        => 'art',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/art/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/art/'      // URL of upload directory
    ),
    47 => array(                                                            // ID of upload destination
        'name'        => 'sample',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/sample/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/sample/'      // URL of upload directory
    ),
    56 => array(                                                            // ID of upload destination
        'name'        => 'message',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/message/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/message/'      // URL of upload directory
    ),
    57 => array(                                                            // ID of upload destination
        'name'        => 'flowers',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/flowers/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/flowers/'      // URL of upload directory
    ),
    58 => array(                                                            // ID of upload destination
        'name'        => 'brides',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/wedding/brides/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/wedding/brides/'      // URL of upload directory
    ),
    55 => array(                                                            // ID of upload destination
        'name'        => 'couples',                          // Display name in control panel
        'server_path' => '/var/www/html/da-qu.com/msm/images.da-qu.com/assets/images/uploads/wedding/couples/', // Server path to upload directory
        'url'         => 'http://images.da-qu.com/assets/images/uploads/wedding/couples/'      // URL of upload directory
    )
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/var/www/html/da-qu.com/msm/images.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://images.da-qu.com/cache',
