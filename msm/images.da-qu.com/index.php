 ...
 */
   ...
   $assign_to_config['cp_url'] = 'http://local.images.da-qu.com/admin.php'; 
   $assign_to_config['site_url'] = 'http://local.images.da-qu.com/'; 
...
$assign_to_config['tmpl_file_basepath'] = '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/templates';
...
$assign_to_config['upload_preferences'] = array(
    ...
    46 => array(                                                            // ID of upload destination
        ...
        'url'         => 'http://local.images.da-qu.com/assets/images/uploads/art/'      // URL of upload directory
    ),
    47 => array(                                                            // ID of upload destination
        'name'        => 'sample',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/assets/images/uploads/sample/', // Server path to upload directory
        'url'         => 'http://local.images.da-qu.com/assets/images/uploads/sample/'      // URL of upload directory
    ),
    56 => array(                                                            // ID of upload destination
        'name'        => 'message',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/assets/images/uploads/message/', // Server path to upload directory
        'url'         => 'http://local.images.da-qu.com/assets/images/uploads/message/'      // URL of upload directory
    ),
    57 => array(                                                            // ID of upload destination
        'name'        => 'flowers',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/assets/images/uploads/flowers/', // Server path to upload directory
        'url'         => 'http://local.images.da-qu.com/assets/images/uploads/flowers/'      // URL of upload directory
    ),
    58 => array(                                                            // ID of upload destination
        'name'        => 'brides',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/assets/images/uploads/wedding/brides/', // Server path to upload directory
        'url'         => 'http://local.images.da-qu.com/assets/images/uploads/wedding/brides/'      // URL of upload directory
    ),
    55 => array(                                                            // ID of upload destination
        'name'        => 'couples',                          // Display name in control panel
        'server_path' => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/assets/images/uploads/wedding/couples/', // Server path to upload directory
        'url'         => 'http://local.images.da-qu.com/assets/images/uploads/wedding/couples/'      // URL of upload directory
    )
);
...
$config['minimee'] = array(
     ...
     */
    'cache_path'        => '/Users/tongxiaoxian/Sites/local.da-qu.com/msm/images.da-qu.com/cache',
 
    /**
     * The URL to the cache folder.
     * Defaults to $EE->config->item('base_url') + '/cache'
     */
    'cache_url'         => 'http://local.images.da-qu.com/cache',
